...
{
    public class FeatureTableViewCell: MvxTableViewCell
    {
        UILabel TitleLabel;
        ...
        public FeatureTableViewCell()
        {
            InitialiseSubviews();
            InitialiseBindings();
        }

        public FeatureTableViewCell(IntPtr handle)
            : base(handle)
        {
            InitialiseSubviews();
            InitialiseBindings();
        ...
        private void InitialiseSubviews()
        {
            ...
            {
                ItemSize = new SizeF(200, 129),
                ScrollDirection = UICollectionViewScrollDirection.Horizontal
            };

            CollectionView = new UICollectionView(new RectangleF(0f, 24f, (float)width, 129f), layout);
